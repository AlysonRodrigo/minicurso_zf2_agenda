...
namespace DoctrineORMModule\Proxy\__CG__\Agenda\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Contato extends \Agenda\Entity\Contato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'id', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'nome', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'email', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'telefone', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'celular', '' . "\0" . 'Agenda\\Entity\\Contato' . "\0" . 'usuario'];
        }
