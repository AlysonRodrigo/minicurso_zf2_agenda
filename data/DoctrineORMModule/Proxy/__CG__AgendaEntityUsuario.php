 ...
 */
class Usuario extends \Agenda\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Agenda\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Agenda\\Entity\\Usuario' . "\0" . 'nome', '' . "\0" . 'Agenda\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Agenda\\Entity\\Usuario' . "\0" . 'senha', '' . "\0" . 'Agenda\\Entity\\Usuario' . "\0" . 'contato'];
        }
